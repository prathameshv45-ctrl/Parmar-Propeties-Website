    ...
    <div className="min-h-screen pt-16" style={{ backgroundColor: 'var(--pp-bg)' }}>
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <p style={{ fontSize: '18px', color: 'var(--pp-primary-light)' }}>
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          {[
            ...
            <div
              key={index}
              className="bg-white p-8 rounded-[var(--radius-card)] text-center"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-[var(--radius-card)] p-8" style={{ boxShadow: 'var(--shadow-card)' }}>
            ...
            <form className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-[var(--radius-btn)] bg-[var(--pp-primary)] text-white flex items-center justify-center gap-2 transition-colors hover:bg-[var(--pp-primary-dark)]"
          ...
          <div className="rounded-[var(--radius-card)] overflow-hidden" style={{ boxShadow: 'var(--shadow-card)' }}>
            <div className="w-full h-full min-h-[500px] bg-[var(--pp-bg)] flex items-center justify-center">
